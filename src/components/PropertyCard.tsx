  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-[0_1px_2px_rgba(15,18,20,0.06)] ring-1 ring-grafite/5 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_20px_40px_-16px_rgba(15,18,20,0.25)]"
      >
        ...
        <div className="flex flex-1 flex-col gap-3 p-5">
          <div>
            <h3 className="font-display text-[17px] font-semibold leading-snug tracking-tight text-grafite">
              {property.title}
            </h3>
            <p className="mt-1 flex items-center gap-1.5 font-display text-[13px] text-grafite-muted">
              <MapPin className="h-3.5 w-3.5 shrink-0 text-azul-escritura" strokeWidth={2.2} />
          ...
          <div className="mt-auto flex items-center gap-4 border-t border-grafite/8 pt-3.5 text-grafite-muted">
            <span className="flex items-center gap-1.5 font-mono text-[12px]">
              <BedDouble className="h-4 w-4" strokeWidth={2} /> {property.bedrooms}
            </span>
            <span className="flex items-center gap-1.5 font-mono text-[12px]">
              <Bath className="h-4 w-4" strokeWidth={2} /> {property.bathrooms}
            </span>
            <span className="flex items-center gap-1.5 font-mono text-[12px]">
              <Ruler className="h-4 w-4" strokeWidth={2} /> {formatArea(property.areaM2)}
            </span>
          </div>
        </div>
      </Link>
