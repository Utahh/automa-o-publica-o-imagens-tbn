...
export function Hero() {
  ...
  // Com "reduzir movimento", o conteúdo já nasce visível, sem entrada.
  const initial = (state: TargetAndTransition) => (reduceMotion ? false : state);

  return (
    <section className="relative flex min-h-[86svh] flex-col overflow-hidden bg-grafite-noite pt-24">
      ...
      <motion.div
        ...
        className="relative mx-auto mb-8 hidden items-center gap-2 font-mono text-xs uppercase tracking-[0.2em] text-papel-muted sm:flex"
      >
        <motion.span
